...
def patch_blocks(n,
                 ...
                 update_repeat_annotations=False,
                 trim=False,
...
def parse_args():
    ...
    block_patch.add_argument('--max-simultaneous-tasks', help='maximum number '
                             'of tasks allowed to run simultaneously '
                             '(default: N)', type=int)
    block_patch.add_argument('--update-repeat-annotations',
                             help='adjust repeat track intervals based on the '
                             'changes made to the read', action='store_true')
...
def main():
    ...
    if args.subcommand == 'blocks' and args.subsubcommand == 'patch':
        patch_blocks(n=args.n,
                     max_simultaneous_tasks=args.max_simultaneous_tasks,
                     update_repeat_annotations=args.update_repeat_annotations,
                     trim=args.trim,
